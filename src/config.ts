...
export interface Config {
  ...
  /** Puppeteer Git 平台 Logo 类型 */
  puppeteerLogoType: 'svg' | 'emoji'
...
export const Config: Schema<Config> = Schema.intersect([
  ...
  Schema.object({
    ...
    typstLogoType: Schema.union([
      Schema.const('svg').description('🖼️ SVG Logo：使用原生 SVG 图标，显示效果最佳'),
      Schema.const('emoji').description('😊 Emoji Logo：使用 Emoji 图标，兼容性更好'),
    ])
      .role('radio')
      .default('svg')
      .description('🎨 Typst Git 平台 Logo 类型'),
  ...
  Schema.object({
    ...
    puppeteerLogoType: Schema.union([
      Schema.const('svg').description('🖼️ SVG Logo：使用原生 SVG 图标，显示效果最佳'),
      Schema.const('emoji').description('😊 Emoji Logo：使用 Emoji 图标，兼容性更好'),
    ])
      .role('radio')
      .default('svg')
      .description('🎨 Puppeteer Git 平台 Logo 类型'),
